...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const calender = new Calender('[data-calender-title="month"]', '[data-calender-title="year"]', '[data-button="next-month"]', '[data-button="prev-month"]', '[data-container="calender-days"]', '[data-schedule-date="agenda"]', '[data-schedule-time="agenda"]').init();
});